    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl">
        ...
        <p className="text-muted-foreground text-sm">
          Your review helps others learn about great AI tools. Please note that your review will be
          moderated before it is published.
        </p>
        ...
        <form onSubmit={handleSubmit} className="mt-4 flex flex-col gap-4">
          ...
          <p className="text-muted-foreground text-xs">Review should be more than 35 characters.</p>
