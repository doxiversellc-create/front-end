  ...
  return (
    <section className="mt-10 mb-20 w-full md:mb-28 lg:mb-32">
      <div className="relative min-w-full rounded-3xl">
        <div className="bg-background relative min-w-full overflow-hidden rounded-3xl">
          <div
          ...
          <div className="absolute bottom-0 z-10 flex w-full items-center justify-center">
            <Image src="/shapes/vendorSubmit.svg" alt="vendor Submit" width={200} height={100} />
          </div>
          <div className="relative z-10 mt-5 space-y-5 px-4 pb-20 text-center md:px-6 md:pb-24 lg:px-20 lg:pb-28">
            ...
            <p className="text-foreground mx-auto mt-6 max-w-md justify-center text-center md:max-w-xl lg:max-w-2xl lg:text-lg">
              ...
              delivering trusted, high-quality solutions. Once approved, your tool will be listed on
              Doxiverse with a link to your official site.
            </p>
