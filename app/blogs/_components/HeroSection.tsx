...
export default function HeroSection() {
  return (
    <section className="bg-gradient-to-b px-3 lg:px-0 from-[#9FCFEE] to-primary/0 pt-28 pb-12 flex flex-col items-center justify-center gap-5">
      ...
      <p className="max-w-[709px] text-center text-base md:text-lg font-inter">
